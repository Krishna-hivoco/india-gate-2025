...
//   return (
//     <div className="bg-[url('/common/bg.png')]   bg-[rgba(255,247,226,0.78)]">
...
//               <Image src={`/home/ab.png`} alt={`ab`} width={246} height={387} />
...
//                   height={230}
//                 />
//                 <p className="text-lg md:text-xl regulat-text">
//                   Through #GrainsOfHope,Share this initiative and let’s put a
//                   full plate of food in front of a child who needs it.
//                 </p>
//               </div>
//             </div>
//             <div className={"rounded-2xl"}>
//               <YouTubeEmbed videoid="LB8Xp9DKRCQ" height={400} width={720} />
//             </div>
//           </div>
//         </section>
...
//      console.log("Video ID: LB8Xp9DKRCQ");
//      console.log("Timestamp:", new Date().toISOString());
//      // You can add more tracking logic here
//      // Analytics, user engagement tracking, etc.
//    };
...
//       <div className="bg-[url('/common/bg.png')] bg-[rgba(255,247,226,0.78)] md:h-screen overflow-hidden">
...
//                       height={400}
//                       width={720}
//                       params="enablejsapi=1&origin=https://yourdomain.com"
//                     />
//                   </div>
//                 </div>
//               </div>
...
//                 <div className="w-60 ring bg-[#6D4036] flex justify-center items-center py-3 gap-1 rounded-full mt-2">
...
//                   />
//                 </div>
//                 <strong className="mt-1 text-4xl">123940</strong>
//                 <span className="text-xs regular-text">Shares & counting</span>
//               </div>
//             </div>

//             {/* Mobile Layout */}
//             <div className="md:hidden   container mx-auto h-full flex flex-col px-4 gap-5">
...
//                   />
//                 </div>
//                 <div className="flex-1 flex items-center text-center flex-col gap-3 ">
//                   <Image
//                     src={`/home/logo.png`}
//                     alt={`logo`}
//                     width={150}
//                     height={155}
//                   />
//                   <p className="text-sm bold-text">
//                     Through <b> #GrainsOfHope, </b> <br /> Share this initiative
//                     and let's put a full plate of food <br /> in front of a
//                     child who needs it.
//                   </p>
//                 </div>
//               </div>
...
//                   />
//                 </div>
//                 <strong className="mt-2 text-4xl">123940</strong>
//                 <span className="text-xs regular-text">Shares & counting</span>
//               </div>
...
//       <div className="bg-[rgba(255,247,226,0.78)] bg-[url('/common/bg.png')]">
//         <div className="container mx-auto">
//           <footer>
//             <FooterCard />
//             <FooterTop />
...
//       }
//     } else {
//       // Fallback to social media popup
//       setShowSharePopup(true);
//     }
//   };
...
//       // For Instagram, we'll copy the text to clipboard since they don't support direct sharing
...
//   // YouTube player options for desktop
//   const desktopOpts = {
//     height: "400",
//     width: "720",
//     playerVars: {
...
//   // YouTube player options for mobile
//   const mobileOpts = {
//     height: "100%",
//     width: "100%",
//     playerVars: {
...
//     <>
//       {/* Main content section - exactly screen height */}
//       <div className="bg-[url('/common/bg.png')] bg-[rgba(255,247,226,0.78)] bg-no-repeat bg-cover md:h-screen overflow-hidden">
//         <div className="h-full flex flex-col">
//           <header className="flex-shrink-0">
//             <Header />
//           </header>
...
//                   <button
//                     onClick={handleShare}
//                     className="cursor-pointer text-white text-2xl bold-text"
//                   >
//                     Share
//                   </button>
//                   <Image
...
//             {/* Mobile Layout */}
//             <div className="md:hidden  mx-auto h-full flex flex-col pr-4 gap-5">
//               {/* Top row - AB image and text content */}
//               <div className="flex items-center gap-4">
//                 <div className="flex-shrink-0 ">
//                   <Image
...
//       {/* Footer section - starts after screen height */}
//       <div className="bg-[rgba(255,247,226,0.78)] bg-no-repeat bg-cover bg-[url('/common/bg.png')]">
//         <div className="container mx-auto">
//           <footer>
//             <FooterCard />
//             <FooterTop />
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <section className="flex-1 flex items-center relative">
            ...
            {/* Mobile Layout */}
            <div className="md:hidden mx-auto h-full flex flex-col  gap-5">
              {/* Top row - AB image and text content */}
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0">
                  <Image
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <strong className="mt-2 text-4xl">12330</strong>
                <span className="text-xs regular-text">Shares & counting</span>
              </div>
